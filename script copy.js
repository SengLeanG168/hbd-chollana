...
// --- ៤. មុខងារសម្រាប់ត្រឡប់ទំព័រសៀវភៅ 3D ---
const pages = document.querySelectorAll('.page');
const book = document.querySelector('.book'); 
let currentPage = 0;

pages.forEach((page, index) => {
  // កំណត់ z-index ដំបូងឱ្យបានត្រឹមត្រូវ (ទំព័រមុខគេនៅចុងតារាង)
  ...
  page.addEventListener('click', () => {
    ...
    if (currentPage === index) {
      ...
      // បន្ទាប់ពីត្រឡប់រួច បញ្ចុះ z-index ឱ្យទាប ដើម្បីកុំឱ្យបាំងទំព័របន្ទាប់
      setTimeout(() => {
        page.style.zIndex = index;
      }, 500); // ៥០០ms ជាពាក់កណ្តាលនៃល្បឿនបង្វិល
    ...
    // បើចុចត្រឡប់ថយក្រោយ
      ...
      // មុននឹងបិទត្រឡប់មកវិញ ដំឡើង z-index ឱ្យខ្ពស់វិញ
      page.style.zIndex = pages.length - index;
      
      currentPage--;
    }
    
    // មុខងាររំកិលសៀវភៅមកកណ្តាលពេលកំពុងបើក
    if (currentPage > 0) {
